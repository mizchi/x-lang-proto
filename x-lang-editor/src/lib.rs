...
use x_lang_parser::{CompilationUnit, AstNode};
use x_lang_checker::CheckResult;
...
mod tests {
    ...
    fn test_convenience_functions() {
        ...
        let operation = EditOperation::Insert(InsertOperation {
            path: vec![0],
            node: AstNode::Literal(x_lang_parser::Literal::Int(100)),
        });
