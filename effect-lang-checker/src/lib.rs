//! EffectLang Type Checker
//! 
//! This crate provides type checking and semantic analysis for EffectLang.
...
use effect_lang_parser::{CompilationUnit, Symbol, Span};
...
pub struct SymbolInfo {
    ...
    pub span: Span,
    pub visibility: effect_lang_parser::Visibility,
}
