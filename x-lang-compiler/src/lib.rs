...
use x_lang_parser::{CompilationUnit, SyntaxStyle};
use x_lang_checker::{type_check, CheckResult};
...
pub struct CompilerDiagnostic {
    ...
    pub span: Option<x_lang_parser::Span>,
}
...
pub mod convenience {
    ...
    pub fn type_check_source(source: &str) -> Result<CheckResult, CompilerError> {
        use x_lang_parser::{parse_source, FileId};
