...
//! 
//! This backend generates TypeScript code from EffectLang IR,
...
impl CodegenBackend for TypeScriptBackend {
    ...
    fn generate_runtime(&self, _options: &CodegenOptions) -> Result<String> {
        ...
        writeln!(code, "// EffectLang Runtime for TypeScript")?;
        writeln!(code, "")?;
...
impl TypeScriptBackend {
    ...
    fn generate_ir_module(
        ...
        writeln!(code, "// Generated from EffectLang module: {}", module.name)?;
        writeln!(code, "")?;
    ...
    fn generate_type_definitions(&self, _ir: &IR) -> Result<String> {
        let mut code = String::new();
        writeln!(code, "// EffectLang Type Definitions")?;
        writeln!(code, "")?;
        writeln!(code, "declare global {{")?;
        writeln!(code, "  namespace EffectLang {{")?;
